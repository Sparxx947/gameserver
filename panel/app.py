...
# Erzeugt von werkzeuge/logo.py - NICHT von Hand aendern. Dort stehen die
# Formen als Zahlen, und favicon.svg, favicon.ico und apple-touch-icon.png
# entstehen aus denselben. Wer hier haendisch nachbessert, hat vier
# Fassungen, von denen drei alt sind.
# *Generated by werkzeuge/logo.py; editing here leaves the other three
#  outputs stale.*
LOGO = ('<svg class=logo viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden=true><rect x=1 y=1 width=30 height=30 rx=8 fill="#3f9c6d"/><path d="M1 6h30v6.5H1z" fill="#4caf7d" opacity=".45"/><path d="M1 19h30v6.5H1z" fill="#4caf7d" opacity=".45"/><path d="M5.0 16.0H27.0" stroke="#eef1f4" stroke-width=2.2 stroke-linecap="round"/><circle cx="16" cy="16.0" r="5.4" fill="none" stroke="#eef1f4" stroke-width=2.2/><circle cx="16" cy="16.0" r="1.4" fill="#eef1f4"/></svg>')
