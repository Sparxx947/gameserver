...
PAARE=(
  ...
  "bin/platzwart-metriken:/usr/local/bin/platzwart-metriken"
  "bin/platzwart-protokolle:/usr/local/bin/platzwart-protokolle"
  "bin/platzwart-ereignisse:/usr/local/bin/platzwart-ereignisse"
  "systemd/platzwart-ereignisse.service:/etc/systemd/system/platzwart-ereignisse.service"
  "systemd/platzwart-ereignisse.timer:/etc/systemd/system/platzwart-ereignisse.timer"
  "systemd/platzwart-protokolle.service:/etc/systemd/system/platzwart-protokolle.service"
  "etc/module/statistik/loki.vorlage.yml:/etc/module/statistik/loki.vorlage.yml"
  "etc/module/statistik/grafana/dashboards/protokolle.json:/etc/module/statistik/grafana/dashboards/protokolle.json"
  ...
  "etc/module/statistik/grafana/provisioning/datasources/prometheus.yaml:/etc/module/statistik/grafana/provisioning/datasources/prometheus.yaml"
  "etc/module/statistik/grafana/provisioning/dashboards/platzwart.yaml:/etc/module/statistik/grafana/provisioning/dashboards/platzwart.yaml"
  "etc/module/statistik/grafana/server-vorlage.json:/etc/module/statistik/grafana/server-vorlage.json"
  "etc/module/statistik/grafana/dashboards/maschine.json:/etc/module/statistik/grafana/dashboards/maschine.json"
  "etc/module/statistik/grafana/dashboards/spielserver.json:/etc/module/statistik/grafana/dashboards/spielserver.json"
  "etc/module/statistik/grafana/dashboards/container.json:/etc/module/statistik/grafana/dashboards/container.json"
  "etc/module/statistik/grafana/dashboards/netz.json:/etc/module/statistik/grafana/dashboards/netz.json"
  "etc/module/statistik/grafana/dashboards/selbst.json:/etc/module/statistik/grafana/dashboards/selbst.json"
  "etc/module/statistik/grafana/dashboards/sicherung.json:/etc/module/statistik/grafana/dashboards/sicherung.json"
  "etc/module/statistik/grafana/dashboards/web.json:/etc/module/statistik/grafana/dashboards/web.json"
