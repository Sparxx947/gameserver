...
Ein TeamSpeak- und ein Discord-Kanal je Spielserver. Läuft als `kanal-abgleich.service` (Timer
...
`/opt/panel/daten/{kanaele.json, teamspeak.conf, discord.conf, kanaele-zuordnung.json}`.
